  ...
  return (
    <section className="relative min-h-screen overflow-hidden pt-16">
      ...
      <div className="relative z-10 mx-auto flex max-w-7xl flex-col justify-center px-4 pt-32 pb-20">
        <div className="mb-6 inline-flex w-fit items-center gap-2 rounded-full border border-brand-green/30 bg-brand-green/10 px-4 py-2 animate-fade-in">
          <span className="h-2 w-2 rounded-full bg-brand-green animate-pulse" />
          <span className="text-sm font-medium text-brand-green">Next-Gen AI Deal Platform on Solana</span>
        </div>

        <h1 className="max-w-3xl text-5xl font-bold leading-tight tracking-tight md:text-7xl animate-fade-in" style={{ animationDelay: "150ms", animationFillMode: "both" }}>
          AI that creates, controls and completes{" "}
          <span className="text-gradient-purple">your deals automatically</span>
        </h1>

        <p className="mt-6 max-w-xl text-lg text-muted-foreground animate-fade-in" style={{ animationDelay: "300ms", animationFillMode: "both" }}>
        ...
        <div className="mt-10 flex flex-wrap gap-4 animate-fade-in" style={{ animationDelay: "450ms", animationFillMode: "both" }}>
          ...
          <Link
            to="/wallet"
            className="flex items-center gap-2 rounded-xl border border-brand-green bg-brand-green/10 px-8 py-4 text-base font-semibold text-brand-green transition-all hover:bg-brand-green/20 hover:scale-105 glow-green"
          >
        ...
        <div className="mt-12 flex flex-wrap gap-6 text-sm text-muted-foreground animate-fade-in" style={{ animationDelay: "600ms", animationFillMode: "both" }}>
